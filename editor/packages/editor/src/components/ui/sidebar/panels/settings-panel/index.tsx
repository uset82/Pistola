...
export function SettingsPanel({
  ...
  const handleExport = () => void runAssistantCommand([{ type: 'export_scene', format: 'glb' }])
  ...
  return (
    <div className="flex flex-col gap-6 p-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                void runAssistantCommand([{ type: 'set_grid_visibility', enabled: checked }])
              }
            />
          </div>
        </div>
      ...
      <div className="space-y-2">
        ...
        <Button className="w-full justify-start gap-2" onClick={handleIfcExport} variant="outline">
          <Download className="size-4" />
          Export BIM Metadata (IFC)
        </Button>
      </div>
