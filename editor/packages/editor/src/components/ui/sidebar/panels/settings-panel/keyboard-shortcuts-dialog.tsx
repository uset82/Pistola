...
const SHORTCUT_CATEGORIES: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ['G'], action: 'Move transform target' },
      {
        keys: ['R'],
        action: 'Rotate transform target or item placement',
        note: 'Outside the CAD phase.',
      },
      {
        keys: ['E'],
        action: 'Scale transform target',
        note: 'Outside the CAD phase.',
      },
  ...
  },
  {
    title: 'CAD Workspace',
    shortcuts: [
      { keys: ['S'], action: 'Activate the CAD sketch tool', note: 'Only in the CAD phase.' },
      { keys: ['L'], action: 'Activate the line tool', note: 'Only in the CAD phase.' },
      { keys: ['T'], action: 'Activate the rectangle tool', note: 'Only in the CAD phase.' },
      { keys: ['O'], action: 'Activate the circle tool', note: 'Only in the CAD phase.' },
      { keys: ['E'], action: 'Activate the extrude tool', note: 'Only in the CAD phase.' },
      { keys: ['R'], action: 'Activate the revolve tool', note: 'Only in the CAD phase.' },
    ],
  },
  {
    title: 'Selection',
