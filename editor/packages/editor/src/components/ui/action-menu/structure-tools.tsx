...
import type { AssistantTool } from '../../../lib/assistant'
...
export type ToolConfig = {
  id: Extract<StructureTool, AssistantTool>
  iconSrc: string
  label: string
                ...
                void runAssistantCommand([
                  {
                    ...
                    layer: tool.id === 'zone' ? 'zones' : 'elements',
                  },
                  {
                    type: 'activate_tool',
                    tool: tool.id,
                    catalogCategory: tool.catalogCategory ?? null,
                  },
                ])
              }
            }}
