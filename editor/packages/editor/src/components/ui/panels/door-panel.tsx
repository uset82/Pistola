...
import { type AnyNode, DoorNode, emitter, useScene } from '@pascal-app/core'
      ...
      void runAssistantCommand([
        {
          ...
          ...(typeof updates.threshold === 'boolean' ? { threshold: updates.threshold } : {}),
          ...(typeof updates.thresholdHeight === 'number'
            ? { thresholdHeight: updates.thresholdHeight }
            : {}),
          ...(updates.hingesSide ? { hingesSide: updates.hingesSide } : {}),
          ...(updates.swingDirection ? { swingDirection: updates.swingDirection } : {}),
          ...(updates.segments ? { segments: updates.segments } : {}),
          ...(typeof updates.handle === 'boolean' ? { handle: updates.handle } : {}),
          ...(typeof updates.handleHeight === 'number'
            ? { handleHeight: updates.handleHeight }
            : {}),
          ...(updates.handleSide ? { handleSide: updates.handleSide } : {}),
          ...(updates.contentPadding ? { contentPadding: updates.contentPadding } : {}),
          ...(typeof updates.doorCloser === 'boolean' ? { doorCloser: updates.doorCloser } : {}),
          ...(typeof updates.panicBar === 'boolean' ? { panicBar: updates.panicBar } : {}),
          ...(typeof updates.panicBarHeight === 'number'
            ? { panicBarHeight: updates.panicBarHeight }
            : {}),
        },
      ])
    },
