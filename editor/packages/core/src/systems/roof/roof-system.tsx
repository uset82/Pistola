      ...
      if (node.type === 'roof-segment') {
        ...
        if (mesh) {
          ...
          if (isVisible && segmentsProcessed < MAX_SEGMENTS_PER_FRAME) {
            ...
            // Replace the initial BoxGeometry once: it has 6 face-groups (materialIndex 0-5).
            // roofMaterials now has 6 guard entries, but the placeholder swap is still
            // desirable so MeshBVH doesn't needlessly index a 6-group geometry.
