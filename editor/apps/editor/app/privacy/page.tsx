        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8 space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6 text-foreground/90">
              <li>Email address</li>
              <li>Password hash and session data needed to keep you signed in</li>
            </ul>
            ...
            <h3 className="mt-4 font-medium text-lg">AI Feature Data</h3>
            <p className="text-foreground/90 leading-relaxed">
              When you use AI-assisted features, we may send prompts, scene summaries, selected
              workspace metadata, and any reference images you attach to our AI providers to
          ...
          <section className="mb-8 space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6 text-foreground/90">
              ...
              <li>Generate AI assistant responses, plans, and CAD briefs</li>
              <li>
          ...
          <section className="mb-8 space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6 text-foreground/90">
              <li>
                <strong>OpenAI</strong> - AI inference for assistant and CAD planning features
              </li>
              <li>
                <strong>Vercel</strong> - Application hosting, analytics, and performance monitoring
              </li>
              <li>
                <strong>Supabase</strong> - Database hosting and PostgreSQL infrastructure
              </li>
            </ul>
