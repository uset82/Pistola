      ...
      <main className="container mx-auto max-w-3xl px-6 py-12">
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8 space-y-4">
            ...
            <p className="text-foreground/90 leading-relaxed">
              To use certain features of the Platform, you must create a Pistola account with the
              email/password flow we provide. You may use the same email address you use with
              OpenAI, but OpenAI or ChatGPT credentials are not used as a direct end-user sign-in
              method for the Platform. You are responsible for maintaining the security of your
